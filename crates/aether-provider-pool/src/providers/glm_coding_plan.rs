...
pub const GLM_CODING_PLAN_DEFAULT_ZAI_BASE_URL: &str = "https://api.z.ai/api/anthropic";
pub const GLM_CODING_PLAN_DEFAULT_ZHIPU_BASE_URL: &str = "https://open.bigmodel.cn/api/anthropic";
pub const GLM_CODING_PLAN_MODEL_USAGE_PATH: &str = "/api/monitor/usage/model-usage";
pub const GLM_CODING_PLAN_TOOL_USAGE_PATH: &str = "/api/monitor/usage/tool-usage";
...
pub fn build_glm_coding_plan_pool_quota_request_with_base_url(
    ...
    let path = match quota_kind {
        ...
        "tool_usage" => GLM_CODING_PLAN_TOOL_USAGE_PATH,
...
fn glm_coding_plan_monitor_url(base_url: &str, path: &str, query: Option<&str>) -> String {
    ...
    let base = if base.is_empty() {
        GLM_CODING_PLAN_DEFAULT_ZAI_BASE_URL
    } else {
        base
    };
...
mod tests {
    ...
    fn builds_zhipu_quota_limit_request_from_anthropic_base_url() {
        let spec = build_glm_coding_plan_pool_quota_request_with_base_url(
            "key-1",
            GLM_CODING_PLAN_DEFAULT_ZHIPU_BASE_URL,
            "token-1",
            "quota_limit",
            None,
        );
